...
- **토글→md 절차**: 노션 '🧠 NEXUS 마스터 지침(공유 두뇌)' 페이지의 **대제목 토글** 밑에 사용자가 사람 말로 지침을 작성하면 → Claude가 그것을 **md로 변환**해 이 NEXUS-MD 페이지의 해당 위치에 **제자리 기재**한다.
...
- **묻는 것에만 답하지 말고 창의적 대안을 적극 제시한다.** "무조건 안 된다"로 끝내지 말 것 — ①왜 안 되는지 간단히 ②우회책·대안 1~2개 ③추천안을 함께 제시. **파트너형 조력.**
...
- **넥서스(NEXUS)** = 사용자가 구축한 공유 두뇌. **마스터는 노션 페이지.** 구글드라이브 폴더 "A AI(클로드)"(ID `1CIBrGRVRn6s0Oc9vhfi_Up7LrdCMhu0Y`)는 md 백업·자동화 산출물 저장소.
...
| 워크플로우 | 상태 | 실행위치 | 연동 MD |
|-----------|------|---------|---------|
| 아침 뉴스 브리핑 자동화 | ● 운영중 | 공통 | workflows/아침뉴스_브리핑.md |
| 로컬 동영상 → Notion 재생링크 | ● 운영중 | 공통 | workflows/로컬동영상_노션링크.md |
| 기술자료 PDF → Notion 이미지 삽입 (로컬) | ● 운영중 | 회사PC | workflows/기술자료노션이전.md |
| 기술자료 사내서버 → Notion 이관 (Selenium 무인) | ◐ 검증중 | 회사PC | workflows/기술자료노션이관.md |
| 선행마감교육 보고서 | ● 운영중 | 공통 | workflows/선행마감교육_보고서.md |
| 노션페이지 현장 배포 | ● 운영중 | 공통 | workflows/노션페이지_현장_배포.md |
| 동영상 컷편집 | ● 운영중 | 공통 | workflows/동영상_컷편집.md |
| 교육용 동영상 제작 | ◐ 검증중 | 공통 | workflows/교육동영상_제작.md |
| 구글드라이브 자료 다운로드 및 정리 | ● 운영중 | 회사PC | workflows/구글드라이브_정리.md |
| 프로젝트 정보 업데이트 | ● 운영중 | 공통 | workflows/프로젝트_정보_업데이트.md |
| 보고서 작성 | ● 운영중 | 공통 | workflows/보고서_작성.md |
| 폰 사진 정리 워크플로우 | ◐ 설계중 | 공통 | — |
| 업무일정 관리 | ◐ 설계중 | — | — |
